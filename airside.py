...
DISTANCE_TO_WALL_THRESHOLD_M = 2.5
...
def main(
    ...
    try:
        ...
        while True:
            ...
            # logging.info(f"{mav.get_rc_channel(1).raw} {mav.get_rc_channel(2).raw} {mav.get_rc_channel(3).raw} {mav.get_rc_channel(4).raw}")
